    ...
    return (
      ...
      <div className="flex w-f justify-between">
        <h2 className="text-2xl font-semibold border-b border-primary">
          <span className="text-primary">Antibiotics</span> Table
        </h2>
        <Link to={"/dashboard/create-antibiotic"} className="btn bg-primary hover:bg-blue-800 text-white text-[18px]">
          <IoMdCreate />
          Create
        </Link>
      </div>
      ...
      <div className="flex w-full justify-between items-center">
        <label className="input input-bordered flex items-center gap-2 max-w-xs">
          <input type="text" className="grow" placeholder="Search antibiotics.." />
          <IoSearchSharp />
        </label>
